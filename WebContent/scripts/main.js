  ...
  function loadRecommendedItems() {
    ...
    ajax('GET', url, data,
      ...
      function(res) {
        ...
        if(lng >-65 || lng < -140 || lat < 0){
        	if(lat > 0 && lng < 0){
        		//var test = 'Your location is latitude' + lat + 'longitude' + -lag +'. Service not available outside of U.S., please use VPN.' ;
        		var test = 'Your are at ' + lat.toFixed(4) +'N ' + -lng.toFixed(4) +'W. Service is not available outside of U.S., please use VPN.';
        		showWarningMessage(test);
        	}else if(lat > 0 && lng > 0){
        		var test = 'Your are at ' + lat.toFixed(4) +'N ' + lng.toFixed(4) +'E. Service is not available outside of U.S., please use VPN.';
        		showWarningMessage(test);
        	}else if (lat < 0){
        		if(lng > 0){
        			var test = 'Your are at ' + -lat.toFixed(4) +'S ' + -lng.toFixed(4) +'E. Service is not available outside of U.S., please use VPN.';
            		showWarningMessage(test);
        		}else{
        			var test = 'Your are at ' + -lat.toFixed(4) +'S ' + lng.toFixed(4) +'E. Service is not available outside of U.S., please use VPN.';
            		showWarningMessage(test);
        	...
        	var message = 'No recommended item. Make sure you have favorites';
